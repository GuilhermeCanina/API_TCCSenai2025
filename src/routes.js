...
const enemquestoes = require('./dados/chamarapienem');
...
routes.get('/usuarios', autenticarToken, isAdmin, usuariosController.getAllUsers); 
...
routes.delete('/usuarios/:id', autenticarToken, isAdmin, usuariosController.deleteUser);
...
routes.delete('/me', autenticarToken, usuariosController.deleteMe); 
...
routes.get('/questoes', enemquestoes.getTodas);
routes.get('/questoes/:ano', enemquestoes.getPorAno);
routes.get('/questoes/materia/:materia', enemquestoes.getPorMateria);
routes.get('/questoes/:ano/materia/:materia', enemquestoes.getPorAnoMateria);
